...
<!--	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <!-- END nav -->
     <%                  
                        ...
                        out.println("<form action='./confirmrpaymentflight.htm' method='POST'>"); 
        ...
        <div class="d-flex justify-content-center h-50">
            <div class="card" style="width: 800px; height: fit-content; margin-top: 150px;">
                <div class="card-header" style="background-color: #e9ecef;">
                    <h3 style="color: #111010;"> Please Confirm Your Booking </h3>
                </div>
                                ...
                                <div class="second-row">
                                    ...
                                    <div class="third-row">
                                        <div class="book" style="padding-bottom: 10px;">
                                            ...
                                            <% out.print("<input type='hidden' name='dbookingid' value='"+dbookingid+"'>");%>
                                            <% out.print("<input type='hidden' name='rbookingid' value='"+rbookingid+"'>");%>
                                            <button type='submit' class='btn  login_btn' value='confirmPayment' style="width: -webkit-fill-available;">Confirm Payment</button>
                                        </div>
                                    </div>
                            </div>   
