...
<html>
    ...
    <body>
       <div class="hero-wrap js-fullheight overlay" style="background-image: url('images/flight2.jpg'); opacity: 0.9;background-size: cover;height: 1230px;" data-stellar-background-ratio="0.5">
		...
		<div class="card">
			<div class="card-body">
				<h3 style="color: white;">Sorry! No Flight Options Available</h3>
                                <form action="./flights.htm" method="POST">
                                    <button type="submit" class="btn login_btn"  style="width: fit-content;height: 100px;margin-left: 40px;margin-top: 40px;">Check Other Availability Options</button>
                                </form>
                        </div>
		</div>
	</div>
