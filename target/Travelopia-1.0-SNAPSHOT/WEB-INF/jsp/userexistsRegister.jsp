...
<html>
    ...
    <body>
       <div class="hero-wrap js-fullheight overlay" style="background-image: url('images/image_2.jpg'); opacity: 0.9;background-size: cover;height: 1230px;" data-stellar-background-ratio="0.5">
		...
		<div class="card">
			<div class="card-body">
				<h3 style = "color: white;">Username Already Exists. Please try another username!</h3>
                                <form action="./loginRegister.htm" method="POST">
                                    <button type="submit" class="btn login_btn" value="Home" style="width: fit-content;height: 100px;margin-left: 100px;margin-top: 40px;">Try Again</button>
                                </form>
                        </div>
		</div>
	</div>
